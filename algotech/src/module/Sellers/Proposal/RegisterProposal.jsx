 ...
 * ## telefones 
    ...
    # dados da operação 
    formdata.append("margem", "543.02");
    formdata.append("prazo_inicio", "36");
    formdata.append("prazo_fim", "98");
    formdata.append("valor_operacao", "10000");
    formdata.append("loan_operation_id", "1");
    formdata.append("tables_finance_id", "194");
    formdata.append("financial_agreements_id", "1");
    formdata.append("benefit_id", "1");

 * TODO REALIZAR O POST NAS PROPOSTAS
 * TODO AJUSTAR O MECANISMO DA CRIAÇÃO COM A TRATIVA DE DADOS -> ''
 */
...
const RegisterProposal = () => {
    ...
    const registerProposal = async () => {
        try {
            ...
            navigate("/sellers"); // Redireciona após o sucesso
        } catch (error) {
    ...
    const renderAdditionalFields = () => {
        switch (formData.tipo_pagamento.toLowerCase()) {
            case "pix":
                return (
                    <div className="space-y-4"> {/* Espaçamento entre as linhas */}
                        <div className="flex gap-4"> {/* Primeira linha */}
                            ...
                            <div className="flex-1">
                                <label><strong>Senha do Contra Cheque:</strong></label>
                                <input
                                    type="password"
                                    name="senha_servidor"
                        ...
                        <div className="flex gap-4"> {/* Segunda linha */}
                            <div className="flex-1">
                            ...
                            <div className="flex-1">
                                <label><strong>Data do Despacho:</strong></label>
                                <input
                                    type="date"
                                    name="data_dispacho"
            ...
            case "ordem_pagamento":
                return (
                    <div className="space-y-4"> {/* Espaçamento entre as linhas */}
                        <div className="flex gap-4"> {/* Primeira linha */}
                            <div className="flex-1">
                                <label><strong>Número da Conta:</strong></label>
                                <input
                                    type="text"
                                    name="numero_conta"
                            ...
                            <div className="flex-1">
                                <label><strong>Agência do Banco do Cliente:</strong></label>
                                <input
                                    type="text"
                                    name="agencia_op"
                            ...
                            <div className="flex-1">
                                <label><strong>Dígito Verificador:</strong></label>
                                <input
                                    type="text"
                                    name="agencia_dv"
                        ...
                        <div className="flex gap-4"> {/* Segunda linha */}
                            <div className="flex-1">
                                <label><strong>Tipo de Conta:</strong></label>
                                <input
                                    type="text"
                                    name="tipo_conta"
                        ...
                        <div className="flex gap-4"> {/* Terceira linha */}
                            <div className="flex-1">
                                <label><strong>Data do Despacho:</strong></label>
                                <input
                                    type="date"
    ...
    return (
        <div className="flex-1 p-15 w-full bg-gray-100 h-full text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-xl font-semibold mb-4"><strong>Dados Pessoais:</strong></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label><strong>Data Nacismento:</strong></label>
                        <input 
                            type="text" 
                    ...
                    <div>
                        <label><strong>Naturalidade</strong></label>
                        <input 
                            type="text"
                            name="naturalidade"
                            id="naturalidade"
                    ...
                    <div>
                        <label><strong>Cidade da Naturalidade:</strong></label>
                        <input 
                            type="text"
                ...
                <hr />
                {/* Endereço */}
                <h2 className="text-xl font-semibold mt-6 mb-4"><strong>Endereço:</strong></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div>
                        <label><strong>UF Cidade:</strong></label>
                        <select 
                            name="uf_cidade" 
                            id="uf_cidade"
                    ...
                    <div>
                        <label><strong>Numero do Endereço:</strong></label>
                        <input 
                            type="text" 
                    ...
                    <div>
                        <label><strong>Complemento de Endereço:</strong></label>
                        <input 
                            type="text" 
                ...
                <hr />
                {/* Documentação */}
                <h2 className="text-xl font-semibold mt-6 mb-4"><strong>Documentação:</strong></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <label><strong>Orgão Emissor:</strong></label>
                        <input 
                            type="text" 
                            name="orgao_emissor" 
                            id="orgao_emissor" 
                    ...
                    <div>
                        <label><strong>UF Emissor:</strong></label>
                        <select 
                            name="uf_emissor" 
                            id="uf_emissor"
                ...
                <hr />
                {/* Dados Financeiros  */}
                <h2 className="text-xl font-semibold mt-6 mb-4"><strong>Dados de Finaceiro:</strong></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label><strong>Valor do Salario:</strong></label>
                        <input 
                            type="text"
                            name="valor_salario"
                            id="valor_salario"
                    ...
                    <div>
                        <label><strong>Salário Liquido:</strong></label>
                        <input 
                            type="text" 
                    ...
                    <div>
                    <label><strong>Tipo do Pagamento:</strong></label>
                        <select
                            name="tipo_pagamento"
                            id="tipo_pagamento"
                        ...
                        >
                            <option className="text-gray-400">Selecione</option>
                            <option value="Pix" className="text-gray-400">Pix</option>
                            <option value="credito_em_conta" className="text-gray-400">Crédito em Conta</option>
                            <option value="ordem_pagamento" className="text-gray-400">Ordem de Pagamento</option>
                        </select>
                    </div>
                    <div className="mt-4">
                ...
                <br />
                <hr />
                <h2 className="text-xl font-semibold mt-6 mb-4"><strong>Dados da Operação:</strong></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label><strong>Margem:</strong></label>
                        <input 
                            type="text" 
                            name="margem"
                            id="margem"
                    ...
                    <div>
                        <label><strong>Prazo Início:</strong></label>
                        <input type="text" name="prazo_inicio" id="prazo_inicio" value={formData.prazo_inicio} className="w-full p-2 border rounded"/>
                    </div>
                    <div>
                        <label><strong>Prazo Fim:</strong></label>
                        <input type="text" name="prazo_fim" id="prazo_fim" value={formData.prazo_fim} className="w-full p-2 border rounded"/>
                    </div>
                    <div>
                        <label><strong>Valor da Operação:</strong></label>
                        <input type="number" name="valor_operacao" id="valor_operacao" value={formData.valor_operacao} className="w-full p-2 border rounded" />
                    </div>
                    <div>
                    ...
                    <div>
                        <label><strong>Selecione o Banco:</strong></label>
                        <select 
                            name="bank_id" 
                            id="bank_id" 
                            onChange={handleChange} 
                    ...
                    <div>
                        <label><strong>Selecio o Convênio:</strong></label>
                        <select 
                            ...
                            {financialAgreements.map((agreement) => (
                                <option key={agreement.id_financialagreements} value={agreement.id_financialagreements}>
                    ...
                    <div>
                        <label><strong>Selecione a Tabela:</strong></label>
                        <select 
                ...
                <h2 className="text-xl font-semibold mt-6 mb-4"><strong>Documentos</strong></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
