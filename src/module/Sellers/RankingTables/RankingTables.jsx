...
import RankingTablesProposal from "@module/Sellers/ui/tables/RankingTablesProposal";
...
const RankingTables = () => {
  ...
  const loadRankingTables = async () => {
    ...
    try {
      ...
      const response = await usersApi.rankingTablesFinance();
  ...
  return (
    <div className="flex-1 p-15 w-full bg-gray-100 h-full text-gray-700">
      {/* Título e Breadcrumb */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Ranking de Tabelas</h1>
      ...
      <div className="bg-gray-700 rounded-lg shadow-lg p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-white">Lista de Tabelas</h2>
        ...
        {/* Tabela de ranking do finance */}
        <RankingTablesProposal loading={loading} tables={tables} />
        {/* Paginação */}
        <Pagination
